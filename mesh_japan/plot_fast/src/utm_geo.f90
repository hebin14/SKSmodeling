...
! a list of UTM zones of the world is available at www.dmap.co.uk/utmworld.htm
  ...
  subroutine utm_geo(rlon4,rlat4,rx4,ry4,UTM_PROJECTION_ZONE,iway)
...
!                              0 = ILONGLAT2UTM = geodetic to UTM
!                              1 = IUTM2LONGLAT = UTM to geodetic
...
! input/output parameters
  ...
  integer, intent(in) :: iway,UTM_PROJECTION_ZONE
