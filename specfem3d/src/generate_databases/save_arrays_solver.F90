...
! outputs binary files for single mesh parameters (for example vp, vs, rho, ..)
  ...
  ! MPI interfaces
  use generate_databases_par, only: nibool_interfaces_ext_mesh,ibool_interfaces_ext_mesh,num_interfaces_ext_mesh,ATTENUATION
  ...
  logical,parameter :: SAVE_MESH_FILES_ADDITIONAL = .false.
