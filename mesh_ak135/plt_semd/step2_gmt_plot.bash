...
ampnorm=`echo $ampnorm | awk '{print 1.0/$1}'`
tbeg=0
tend=200
...
gmt begin $out jpg
    ...
    gmt subplot set
    gmt psbasemap -R$tbeg/$tend/-1/$ymax -Bx+l'time(s)'  -BweSn+t'Z comp'
    cat bxz.lst | gmt pssac -Entb -M$sc -W0.5p

    gmt subplot set
    gmt psbasemap -R$tbeg/$tend/-1/$ymax -Bx+l'time(s)'  -BweSn+t'R comp'
    cat bxr.lst | gmt pssac -Entb -M$sc -W0.5p

    gmt subplot set
    gmt psbasemap -R$tbeg/$tend/-1/$ymax -Bx+l'time(s)' -By+l'Trace number' -BwESn+t'T comp'
    cat bxt.lst | gmt pssac -Entb -M$sc -W0.5p
    gmt subplot end
gmt end
